...
ver_file = f'parliament{os.sep}_version.py'
__version__ = None
...
setuptools.setup(
    name="parliament",
    version=__version__,
    author="Braden Bowman",
    author_email="",
    description="Community detection in geospatial data.",
    long_description=long_description,
    long_description_content_type='text/markdown',
    url="https://github.com/braden-bowman/parliament",
    packages=setuptools.find_packages(
        include=('parilament*', ),
        exclude=('*tests', 'tests*')
    ),
    package_data={"parliament": ["py.typed"]},
    classifiers=[
